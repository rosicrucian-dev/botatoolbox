...
const NOTE_FILES: Record<string, string> = {
  ...
  'case-notebook': join(ROOT, 'scripts/vendor/paul-case-notebook.json'),
}
...
// Per-number significance note (e.g. "The Mystic Number of Chokmah"), keyed by
// the bucket number, independent of which words land there.
