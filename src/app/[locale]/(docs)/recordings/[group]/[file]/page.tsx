...
import { splitParagraphs } from '@/lib/transcript-paragraphs'
...
export async function generateMetadata({
  ...
  return {
    title:
      getRecordings(toLocale(locale)).recordingBySlug[file]?.title ??
      'Recording',
  }
}
...
export default async function RecordingTranscript({
  ...
  const paragraphs = starts
    ? splitParagraphs(readLocalizedMarkdown('recordings', locale, rec.slug))
    : null
