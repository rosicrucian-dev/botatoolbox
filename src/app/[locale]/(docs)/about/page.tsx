...
export async function generateMetadata({
  ...
  return {
    title: localizedTitle(locale, 'About'),
  }
}
    ...
    <article className="space-y-6">
      ...
      <Prose>
        <p>
          ...
          <a href="https://rosicrucian.dev">Rosicrucian Developers</a>. For
          questions, contact the lead developer{' '}
          <a href="https://rosicrucian.dev/jonathan">Jonathan</a>. You can open
        ...
        <ul>
          <li>
            <a href="https://agelesswisdom.school">
