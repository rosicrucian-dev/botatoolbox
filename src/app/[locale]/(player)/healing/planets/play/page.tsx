...
function buildSlides(
  planetData: ReturnType<typeof buildPlanetData>,
...
export default function PlanetsPlayPage() {
  ...
  const slides = useMemo(
    () => buildSlides(buildPlanetData(locale), theme, withTimer),
    [locale, theme, withTimer],
  )
