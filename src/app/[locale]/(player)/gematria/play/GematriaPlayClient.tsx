...
// `cardByGlyph` comes from the server page (lib/glyphCards.ts) so the
// tarot dataset stays out of the client bundle.
export function GematriaPlayClient({ cardByGlyph }: { cardByGlyph: CardByGlyph }) {
  const { t } = useT()
