...
import { ritualBySlug, rituals } from '@/content/data'
...
// by slug so adding a ritual needs no per-file import.
function ritualSections(slug: string) {
  const path = join(process.cwd(), 'content/rituals', `${slug}.md`)
  let md: string
  try {
