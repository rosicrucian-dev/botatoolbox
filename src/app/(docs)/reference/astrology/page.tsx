            ...
            {planets.map((p) => {
              ...
              return (
                ...
                >
                  ...
                  <TableCell>
                    <LinkList items={rules} hrefBase="/reference/astrology/signs" />
                  </TableCell>
                  <TableCell>
                    {exalts ? (
                      <LinkList items={[exalts]} hrefBase="/reference/astrology/signs" />
                    ) : (
                      <Dash />
                    )}
                  </TableCell>
            ...
            {signs.map((s) => {
              ...
              return (
                ...
                >
                  ...
                  <TableCell>
                    <LinkList items={rulers} hrefBase="/reference/astrology/planets" />
                  </TableCell>
                  <TableCell>
                    {exalts ? (
                      <LinkList
