...
export const tattvas: ReadonlyArray<Tattva> = [
  {
    ...
    english: 'Earth',
    color: 'tattva-earth',
    flashBg: 'tattva-earth-bg',
    text: 'tattva-text-light',
  },
  {
    kind: 'water',
    english: 'Water',
    color: 'tattva-water',
    flashBg: 'tattva-water-bg',
    text: 'tattva-text-dark',
  },
  {
    kind: 'fire',
    english: 'Fire',
    color: 'tattva-fire',
    flashBg: 'tattva-fire-bg',
    text: 'tattva-text-light',
  },
  {
    kind: 'air',
