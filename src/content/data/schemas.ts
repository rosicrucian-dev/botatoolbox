...
// ---------- public/data/recordings-search.json ----------
//
// GENERATED by scripts/gen-recordings-search.ts — the recordings-scoped
// full-text index (word → [trackIdx, count, …]). Fetched at runtime by the
// recordings search dialog; validated at build inside the generator.
export const RecordingsSearchIndexSchema = z.object({
  tracks: z.array(
    z.object({
      slug: z.string(),
      title: z.string(),
