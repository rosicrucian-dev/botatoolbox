...
//
// GENERATED by scripts/gen-*-search.ts (via scripts/lib/build-search-index.ts)
// — a section-scoped full-text index (word → [trackIdx, count, …]) shared by
// every collection search: recordings transcripts, the Book of Tokens, etc.
// Fetched at runtime by the collection search dialog; validated at build
