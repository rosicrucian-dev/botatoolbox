...
// The Protocol template's homepage flair, restored: a skewed SVG grid
// over a green gradient (#36b49f → #DBFF75), masked to fade out toward
// the top. Uses hardcoded hex rather than `emerald-*` classes, so it
// stays green despite this project's emerald→Apple-blue remap
// (src/styles/tailwind.css). Mounted only on the homepage.
