    ...
    >
      ...
      {SEGMENT_CENTERS.map((lon, i) => {
        ...
        return (
          ...
          >
            {/* The sign glyph already carries U+FE0E (text presentation)
                from the data layer, so Apple renders it as a plain symbol
                instead of a colour emoji \u2014 see content/data/signs.ts. */}
            {sign.glyph}
          </text>
        )
      })}
