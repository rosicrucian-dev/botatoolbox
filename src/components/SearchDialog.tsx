...
// All the heavy search machinery — autocomplete, dialog, highlighting,
// results. Default-exported so `next/dynamic` in Search.tsx can lazy-load
// the whole chunk on first user interaction. Splitting this out reduces
// initial page bundle by ~60-80 KiB (Algolia autocomplete-core,
// react-highlight-words, plus Headless UI Dialog code paths).
